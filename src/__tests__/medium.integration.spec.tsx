...
describe('반복 일정', () => {
  ...
  it('3주 간격, 특정 요일 반복으로 일정을 생성하면 3주 뒤 해당 요일에는 표시되고, 1주 및 2주 뒤 해당 요일에는 표시되지 않는다', async () => {});

  it('특정일에 시작하는 2개월 간격 반복 일정은 시작월과 2개월 뒤 같은 날짜에는 표시되고, 시작 다음 달 같은 날짜에는 표시되지 않는다', async () => {});

  it('특정일에 시작하는 2년 간격 반복 일정은 시작일과 2년 뒤 같은 날짜에는 표시되고, 1년 뒤 같은 날짜에는 표시되지 않는다', async () => {});

  it('매월 반복으로 1월 31일에 생성한 일정은 3월에는 표시되고, 2월과 4월에는 표시되지 않는다', async () => {});
