...
describe('반복 일정', () => {
  ...
  it('매일 반복 일정을 생성하면 다음 날짜에도 동일한 일정이 표시된다', async () => {
    setupMockHandlerCreation();
    ...
    expect(eventList.getByText('매일 반복 회의')).toBeInTheDocument();
  ...
  it('매주 반복 일정을 생성하면 다음 주 같은 요일에 동일한 일정이 표시된다', async () => {
    setupMockHandlerCreation();
  ...
  it('매월 반복 일정을 생성하면 다음 달 같은 날짜에 동일한 일정이 표시된다', async () => {
    setupMockHandlerCreation();
  ...
  it('매년 반복 일정을 생성하면 다음 해 같은 날짜에 동일한 일정이 표시된다', async () => {
    setupMockHandlerCreation();
