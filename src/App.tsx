...
import { isNumberInRange, validateRepeatEndDate } from './utils/validate.ts';
...
function App() {
  ...
  const onClickContinue = async () => {
    ...
    if (eventData.repeat.type !== 'none') await saveRepeatEvents(eventData);
    else await saveEvent(eventData);
    resetForm();
  };
